...
public class Primos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPrimos = new javax.swing.JTextArea();
        btnMostrar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("100 primeros números primos");

        txtPrimos.setColumns(20);
        txtPrimos.setRows(5);
        jScrollPane1.setViewportView(txtPrimos);
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        Integer numero = 2,contador = 0;
        Boolean esPrimo;
        String cadena = "1";
        
        while (contador < 99) {
            // For para verificar si el número en la secuencia es PRIMO
            esPrimo = true;
    ...
    private javax.swing.JTextArea txtPrimos;
